...
public class MedicineInfoController {
	...
	public String mediRevReg(@RequestParam HashMap<String, String> params) throws Throwable {
		...
		if(!seffectNum[0].isEmpty()) {
			...
			//System.out.println("기타효과 길이 : " + effectNum2.length);
			//System.out.println("기타효과     : " + effectNum2[0]);
			System.out.println("기타효과 점수 : " + effect_score_arr2[0]);
			System.out.println("기타효과 : " + effectArr2[0]);
			//기타 효과

$(document).ready(function(){
	...
	$(".effectScoreAddBtn").on("click", function() {
		...
		if(chk1) {
			...
			if($(".effectScore").val() > 0 ) {
				...
				console.log("arr1 = " + $(".effect_arr").val());
				console.log("arr2 = " + $(".effect_score_arr").val());
				console.log("effectNum = " + $(".effectNum").val());
	...
	$(".effectScoreAddBtn2").on("click", function() {
		...
		if(chk3) {
			...
			if($(".effectScore2").val() > 0) {
				...
				//console.log("왜 안들어와 ? : " + $(".effectNum2").val());
				$(".effectScore2").val("");
			}
		}
	});
	...
	$(".seffectScoreAddBtn2").on("click", function() {
		console.log("재희바보 = " + $(".seffectScore2").val());
		...
		if(chk4) {
			...
			if($(".seffectScore2").val() > 0) {
				...
				console.log("sarr3 = " + $(".seffect_arr2").val());
				console.log("sarr4 = " + $(".seffect_score_arr2").val());
				$(".seffectScore2").val("");
			}
		}
	});
